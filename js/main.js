$(document).ready(function () {
            ...
            $(window).scroll(function (event) {
                ...
                $menuSections = $(".navigation #sections ul");
...
//            var chrome = browser.indexOf("Chrome");
            ...
            $introScrlBtn = $("#intro #scrl-dwn-btn");
            $jobDetPanel = $(".job-details");
            $abtSec = $("#about");
            $workSec = $("#work");
            $abtFilter = $("#about-filter");
            $velloLogo = $('#work .job-details img');
            if ($width <= 1320) {
